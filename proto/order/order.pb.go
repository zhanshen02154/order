...
func (x *ConfirmPaymentResponse) GetRevert() bool {
	if x != nil {
		return x.Revert
	}
	return false
...
func (x *ConfirmPaymentResponse) GetStatusCode() string {
	if x != nil {
		return x.StatusCode
	}
	return ""
...
func (x *ConfirmPaymentResponse) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
const file_order_order_proto_rawDesc = "" +
	...
	"\x06Revert\x18\x01 \x01(\bR\x06Revert\x12\x1e\n" +
	"\n" +
	"StatusCode\x18\x02 \x01(\tR\n" +
	"StatusCode\x12\x10\n" +
	"\x03Msg\x18\x03 \x01(\tR\x03Msg2\xf3\x02\n" +
	"\x05Order\x12H\n" +
	"\fGetOrderById\x12\x19.go.micro.service.OrderId\x1a\x1b.go.micro.service.OrderInfo\"\x00\x12V\n" +
	"\tPayNotify\x12\".go.micro.service.PayNotifyRequest\x1a#.go.micro.service.PayNotifyResponse\"\x00\x12`\n" +
	"\x0eConfirmPayment\x12\".go.micro.service.PayNotifyRequest\x1a(.go.micro.service.ConfirmPaymentResponse\"\x00\x12f\n" +
	"\x14ConfirmPaymentRevert\x12\".go.micro.service.PayNotifyRequest\x1a(.go.micro.service.ConfirmPaymentResponse\"\x00B\x0fZ\r./proto/orderb\x06proto3"
...
var file_order_order_proto_goTypes = []any{
	...
	(*ConfirmPaymentResponse)(nil), // 11: go.micro.service.ConfirmPaymentResponse
...
var file_order_order_proto_depIdxs = []int32{
	...
	12, // 2: go.micro.service.OrderPageConditions.order_start_time:type_name -> google.protobuf.Timestamp
	12, // 3: go.micro.service.OrderPageConditions.order_end_time:type_name -> google.protobuf.Timestamp
	...
	9,  // 7: go.micro.service.Order.ConfirmPayment:input_type -> go.micro.service.PayNotifyRequest
	9,  // 8: go.micro.service.Order.ConfirmPaymentRevert:input_type -> go.micro.service.PayNotifyRequest
	1,  // 9: go.micro.service.Order.GetOrderById:output_type -> go.micro.service.OrderInfo
	10, // 10: go.micro.service.Order.PayNotify:output_type -> go.micro.service.PayNotifyResponse
	11, // 11: go.micro.service.Order.ConfirmPayment:output_type -> go.micro.service.ConfirmPaymentResponse
	11, // 12: go.micro.service.Order.ConfirmPaymentRevert:output_type -> go.micro.service.ConfirmPaymentResponse
